...
# Храним session_string, а не клиент
pending_auth = {}  # phone -> session_string
rate_limiter = {}
    ...
    async def verify():
        ...
        try:
            ...
            if await client.is_user_authorized():
                ...
                save_session(phone, final_session)
